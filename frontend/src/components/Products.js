    ...
    return (
      <>
        <div className='buttons d-flex justify-content-center mb-5 pb-5'>
          ...
          <button className='btn btn-outline-dark me-2'onClick={()=>filterProduct("jewelery")}>Food</button>
          <button className='btn btn-outline-dark me-2'onClick={()=>filterProduct("electronics")}>dog accessories</button>
        </div>
        {
          filter.map((product) => {
            return (
